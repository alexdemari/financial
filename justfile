...
market-scanner-execution-backtest universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades.csv" output_summary="reports/market_scanner/execution_summary.csv" output_comparison="reports/market_scanner/execution_rule_comparison.csv" ranking_mode="recent-event" exit_rule="bucket_downgrade" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule {{exit_rule}} --min-trades {{min_trades}}

market-scanner-execution-backtest-all universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades.csv" output_summary="reports/market_scanner/execution_summary.csv" output_comparison="reports/market_scanner/execution_rule_comparison.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule all --min-trades {{min_trades}}

market-scanner-execution-backtest-bucket-downgrade universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_bucket_downgrade.csv" output_summary="reports/market_scanner/execution_summary_bucket_downgrade.csv" output_comparison="reports/market_scanner/execution_rule_comparison_bucket_downgrade.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule bucket_downgrade --min-trades {{min_trades}}

market-scanner-execution-backtest-bars-5 universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_bars_5.csv" output_summary="reports/market_scanner/execution_summary_bars_5.csv" output_comparison="reports/market_scanner/execution_rule_comparison_bars_5.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule bars_5 --min-trades {{min_trades}}

market-scanner-execution-backtest-bars-10 universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_bars_10.csv" output_summary="reports/market_scanner/execution_summary_bars_10.csv" output_comparison="reports/market_scanner/execution_rule_comparison_bars_10.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule bars_10 --min-trades {{min_trades}}

market-scanner-execution-backtest-bars-20 universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_bars_20.csv" output_summary="reports/market_scanner/execution_summary_bars_20.csv" output_comparison="reports/market_scanner/execution_rule_comparison_bars_20.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule bars_20 --min-trades {{min_trades}}
...
market-scanner-execution-backtest-alignment-break universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_alignment_break.csv" output_summary="reports/market_scanner/execution_summary_alignment_break.csv" output_comparison="reports/market_scanner/execution_rule_comparison_alignment_break.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule alignment_break --min-trades {{min_trades}}

market-scanner-execution-backtest-late-state universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_late_state.csv" output_summary="reports/market_scanner/execution_summary_late_state.csv" output_comparison="reports/market_scanner/execution_rule_comparison_late_state.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule late_state --min-trades {{min_trades}}

market-scanner-execution-backtest-opposite-signal universe_file="data/scanner_universe_sample.csv" data_dir="data/stocks/1D" output_trades="reports/market_scanner/execution_trades_opposite_signal.csv" output_summary="reports/market_scanner/execution_summary_opposite_signal.csv" output_comparison="reports/market_scanner/execution_rule_comparison_opposite_signal.csv" ranking_mode="recent-event" min_trades="20":
    uv run python -m market_scanner.backtest_execution --universe-file {{universe_file}} --data-dir {{data_dir}} --output-trades {{output_trades}} --output-summary {{output_summary}} --output-comparison {{output_comparison}} --ranking-mode {{ranking_mode}} --exit-rule opposite_signal --min-trades {{min_trades}}
